...
let topics: Topic[]=[
	...
	{id:"synth_div",name:"Synthetic Div",icon:"÷",category:"Algebra"},
	...
	{id:"linear_programming",name:"Linear Programming",icon:"P",category:"Linear Algebra"},
	{id:"vector3d",name:"3D Vectors",icon:"⟨x,y,z⟩",category:"Linear Algebra"},
	{id:"line3d",name:"3D Lines",icon:"↗",category:"Linear Algebra"},
	...
	{id:"rect_to_polar",name:"Rectangular → Polar",icon:"(x,y)",category:"Trigonometry"},
	...
	{id:"sequence_limit",name:"Sequence Limits",icon:"lim",category:"Discrete Math"},
	...
	{id:"line_plane_3d",name:"Lines & Planes 3D",icon:"↗",category:"Geometry"},
];
const scopeTopics={
