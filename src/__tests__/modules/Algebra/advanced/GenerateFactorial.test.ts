...
import {generateFactorial} from "../../../../modules/Algebra/advanced/GenerateFactorial";
import {seededRng} from "../../../../main/core/Rng";
describe("generateFactorial",()=>{
	it("returns a QuestionDto with required fields",()=>{
		const dto=generateFactorial("medium", seededRng(42));
	...
	it("should handle easy difficulty",()=>{
		const dto=generateFactorial("easy", seededRng(42));
	...
	it("should handle hard difficulty",()=>{
		const dto=generateFactorial("hard", seededRng(42));
		expect(dto.correct).toBeDefined();
	});
	it("returns deterministic output for same seed",()=>{
		const dto1=generateFactorial("medium", seededRng(42));
		const dto2=generateFactorial("medium", seededRng(42));
		expect(dto1).toEqual(dto2);
	});
	it("produces different output for different seeds",()=>{
		const dto1=generateFactorial("medium", seededRng(42));
		const dto2=generateFactorial("medium", seededRng(99));
