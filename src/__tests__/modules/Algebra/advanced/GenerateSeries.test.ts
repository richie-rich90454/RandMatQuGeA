...
import {generateSeries} from "../../../../modules/Algebra/advanced/GenerateSeries";
import {seededRng} from "../../../../main/core/Rng";
describe("generateSeries",()=>{
	it("returns a QuestionDto with required fields",()=>{
		const dto=generateSeries("medium", seededRng(42));
	...
	it("should handle easy difficulty",()=>{
		const dto=generateSeries("easy", seededRng(42));
	...
	it("should handle hard difficulty",()=>{
		const dto=generateSeries("hard", seededRng(42));
		expect(dto.correct).toBeDefined();
	});
	it("returns deterministic output for same seed",()=>{
		const dto1=generateSeries("medium", seededRng(42));
		const dto2=generateSeries("medium", seededRng(42));
		expect(dto1).toEqual(dto2);
	});
	it("produces different output for different seeds",()=>{
		const dto1=generateSeries("medium", seededRng(42));
		const dto2=generateSeries("medium", seededRng(99));
