...
import {generateArithmeticSequence,generateGeometricSequence,generateSequenceLimit,generateInfiniteGeometricSeries,generateMathematicalInduction,generateBinomialTheorem} from "../../../modules/DiscreteMathematics/DiscreteSequenceSeries";
